...
class Day5Test extends AnyFlatSpec {
  ...
  "The Intcode computer" should "support conditional opcodes in position mode" in {
  ...
  "The Intcode computer" should "support conditional opcodes in immediate mode" in {
  ...
  "The Intcode computer" should "support a larger program with conditional opcodes" in {
