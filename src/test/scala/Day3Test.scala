...
class Day3Test extends AnyFlatSpec {
    ...
    "The wire intersection calculator" should "find the correct shortest Manhattan distance of all intersections" in {
    ...
    "The wire intersection calculator" should "find the correct shortest traversed distance of all intersections" in {
