    ...
    def runProgram(program: Array[Int], inputs: Iterator[Int] = Iterator()) = {
        ...
        def processOpCodes(pointer: Int = 0, outputs: List[Int] = Nil): List[Int] = {
            ...
            opCode match {
                ...
                case 4 => { // output
                    processOpCodes(pointer + 2, getParameter(pointer + 1, modes(0)) :: outputs)
                }
                case 5 => { // jump if true
                    processOpCodes(
